...
//        rbConferences.ConferencePublishersUpdated += Conferences_ConferencePublishersUpdated;
...
//        if (rbConferences.PersonalConferenceAllowed())
//        {
...
//    {
//        rbConferences.PersonalConferenceStart(callbackStart =>
//        {
...
//    private void JoinPersonalConference()
//    {
...
//        rbConferences.PersonalConferenceJoin(asModerator, muted, phoneNumber, country, callback =>
//        {
...
//    public void LockOrUnlockConference(bool lockConference)
//    {
//        rbConferences.PersonalConferenceLockOrUnlock(lockConference, callback =>
//        {
//            if (callback.Result.Success)
//            {
...
//    public void MuteOrUnmuteConference(bool mute)
//    {
//        rbConferences.PersonalConferenceMuteOrUnmute(mute, callback =>
//        {
//            if (callback.Result.Success)
//            {
...
//    private void Conferences_ConferencePublishersUpdated(object sender, ConferencePublishersUpdated evt)
//    {
//        if (evt.ConferenceId == conferenceId)
//        {
...
//    private void Conferences_ConferenceTalkersUpdated(object sender, ConferenceTalkersUpdated evt)
//    {
//        if (evt.ConferenceId == conferenceId)
//        {
